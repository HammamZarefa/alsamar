...
class ImageFileHandler
{
    ...
    public function saveAsFile($contents)
    {
        ...
        $filePath = $this->webPath . 'index.html' . $this->imageFolder . 'index.html' . $filename;
        imagejpeg($contents, $filePath, 15);

        return 'index.html' . $this->imageFolder . 'index.html' . $filename;
    }
    ...
    public function collectGarbage()
    {
        ...
        $finder->in($this->webPath . 'index.html' . $this->imageFolder)
            ->date($criteria);
    ...
    {
        if (!file_exists($this->webPath . 'index.html' . $this->imageFolder)) {
            mkdir($this->webPath . 'index.html' . $this->imageFolder, 0755);
        }
    }
}
