<!DOCTYPE html>
<html class="no-js vlt-is--homepage-05 vlt-is--header-default vlt-is--footer-widgetized vlt-is--footer-fixed vlt-is--lowercase-mode"
      lang="ar" dir="{{Lang::locale() == 'en' ? 'ltr' : 'rtl'}}">
<head>
    <meta charset="utf-8">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Alegreya:wght@500&family=Amiri:ital@1&family=Caveat:wght@700&family=Courgette&family=Dancing+Script:wght@700&family=Tajawal:wght@500&display=swap"
          rel="stylesheet">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Alegreya:wght@500&family=Amiri:ital@1&family=Caveat:wght@700&family=Courgette&family=Dancing+Script:wght@700&family=Tajawal&display=swap"
          rel="stylesheet">
...
<div class="vlt-site-preloader">
    <div class="image"><img src="{{ asset('storage/'.$general->logo) }}" alt="" style="width:400px;height: 400px;">
    </div>
</div>
                    ...
                    <div class="container">
                        <div class="vlt-navbar-inner no-gutters">
                            <div class="col text-left">
                                <!--Logo--><a class="vlt-navbar-logo" href="/"><img
                                            src="{{ asset('storage/'.$general->logo) }}" alt=""
                                            style="width: 100PX;"></a>
                            </div>
                            <div class="col text-right"><a class="vlt-menu-burger" href="#" id="vlt-mobile-menu-toggle"><span
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="vlt-widget vlt-widget--white vlt-widget-html">
                            @if($general->facebook)
                                <a class="vlt-social-icon vlt-social-icon--style-2" href="{{$general->facebook}}"
                                   target="_blank"><i class="fa fa-facebook"></i></a>
                            @endif
                            @if($general->twitter)
                                <a class="vlt-social-icon vlt-social-icon--style-2" href="{{$general->twitter}}"
                                   target="_blank"><i class="fa fa-twitter"></i></a>
                            @endif
                            @if($general->linkedin)
                                <a class="vlt-social-icon vlt-social-icon--style-2" href="{{$general->linkedin}}"
                                   target="_blank"><i class="fa fa-linkedin"></i></a>
                            @endif
                            @if($general->instagram)
                                <a class="vlt-social-icon vlt-social-icon--style-2" href="{{$general->instagram}}"
