                            ...
                            <form class="vlt-contact-form" id="reused_form" method="post">
                                <div class="vlt-form-row two-col">
                                    <div class="vlt-form-group">
                                        <input class="vlt-form-control vlt-border-white" type="text" placeholder="@lang('Your Name')" name="your-name" size="40" required>
                                    </div>
                                    <div class="vlt-form-group">
                                        <input class="vlt-form-control vlt-border-white" type="email" placeholder="@lang('Your Email')" name="your-email" size="40" required>
                                    </div>
                                </div>
                                <div class="vlt-form-row two-col">
                                    <div class="vlt-form-group">
                                        <input class="vlt-form-control vlt-border-white" type="tel" placeholder="@lang('Your Phone')" name="your-phone" size="40">
                                    </div>
                                    <div class="vlt-form-group">
                                        <input class="vlt-form-control vlt-border-white" type="text" placeholder="@lang('Your Title')" name="your-title" size="40">
                                    </div>
                                </div>
                                <div class="vlt-form-group">
                                    <textarea class="vlt-form-control vlt-border-white" cols="40" rows="4" placeholder="@lang('Your Message')" name="your-message"></textarea>
                                </div>
                                <!--Button-->
                                <button class="vlt-btn vlt-btn--sixth vlt-btn--lg vlt-btn--effect"><span>@lang('Send Message')</span></button>
