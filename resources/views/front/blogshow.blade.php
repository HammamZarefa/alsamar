...
<main class="vlt-main">
				<!--Page Title-->
				<section class="jarallax"><img class="jarallax-img" src="assets/img/blog-1.jpg" alt="">
								...
								<div id="vlt-grid-blog-05-06-07">
									...
									<article class="vlt-post filter-branding vlt-post--style-default cbp-item">
										<div class="vlt-post-thumbnail clearfix">
											<div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/blog-1.jpg" alt=""></div><a class="vlt-post-thumbnail__link" href="blog-details.html"></a>
										</div>
									...
									<article class="vlt-post filter-events vlt-post--style-default cbp-item">
										<div class="vlt-post-thumbnail clearfix">
											<div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/blog-2.jpg" alt=""></div><a class="vlt-post-thumbnail__link" href="blog-details.html"></a>
										</div>
										<div class="vlt-post-content">
											<header class="vlt-post-header">
									...
									<article class="vlt-post filter-design vlt-post--style-default cbp-item">
										<div class="vlt-post-thumbnail clearfix">
											<div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/blog-3.jpg" alt=""></div><a class="vlt-post-thumbnail__link" href="blog-details.html"></a>
										</div>
										<div class="vlt-post-content">
											<header class="vlt-post-header">
									...
									<article class="vlt-post filter-branding vlt-post--style-default cbp-item">
										<div class="vlt-post-thumbnail clearfix">
											<div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/blog-4.jpg" alt=""></div><a class="vlt-post-thumbnail__link" href="blog-details.html"></a>
										</div>
										<div class="vlt-post-content">
											<header class="vlt-post-header">
