                    ...
                    <div class="picture-container">
                        <div class="picture">
                            ...
                            <input type="file" id="wizard-picture" name="cover"
                                   class="form-control {{$errors->first('cover') ? "is-invalid" : "" }} " value="{{old('cover') ? old('cover') : $portfolio->cover}}">
            ...
            <div class="tab-content" id="myTabContent">
                @foreach(Config::get('app.languages') as $lang)
                        ...
                        <div class="form-group ml-5">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name='name_{{$lang}}'
                                       ...
                                       value="{{old('name_'.$lang) ? old('name_'.$lang) : $portfolio->getTranslation('name',$lang)}}" id="name_{{$lang}}" placeholder="Name {{$lang}}">
                                <div class="invalid-feedback">
                        ...
                        {{--<div class="form-group ml-5">--}}
                            ...
                            {{--<div class="col-sm-9">--}}
                                {{--<input type="text" name='client_{{$lang}}'--}}
                                       ...
                                       {{--value="{{old('client_'.$lang) ? old('client_'.$lang) : $portfolio->getTranslation('client',$lang)}}" id="client_{{$lang}}"--}}
                    ...
                    <textarea name="desc_{{$lang}}" id="desc_{{$lang}}" cols="30" rows="10"
                              ...
                              id="summernote">{{old('desc_'.$lang) ? old('desc_'.$lang) : $portfolio->getTranslation('desc',$lang)}}</textarea>
                                <div class="invalid-feedback">
                                    {{ $errors->first('desc_'.$lang) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group ml-5">
                ...
                <div class="col-sm-9">
                    <input type="text" name='slug'
                           ...
                           value="{{old('slug') ? old('slug') : $portfolio->slug}}" id="slug" placeholder="Slug">
                    <div class="invalid-feedback">
                        {{ $errors->first('slug') }}
                    </div>
                </div>
            ...
            {{--<div class="form-group ml-5">--}}
                ...
                {{--<div class="col-sm-9">--}}
                    {{--<input type="text" name='link'--}}
                           ...
                           {{--value="{{old('link') ? old('link') : $portfolio->link}}" id="link" placeholder="link">--}}
                    {{--<div class="invalid-feedback">--}}
                        {{--{{ $errors->first('link') }}--}}
                    {{--</div>--}}
                {{--</div>--}}
