        ...
        <div class="tab-content" id="myTabContent">
            @foreach($languges as $lang)
                <div class="tab-pane fade {{$lang == 'en' ? "show  active" : ""}}" id="{{$lang}}" role="tabpanel"
                    ...
                    <div class="form-group ml-5">
                        <label for="message1" class="col-sm-2 col-form-label">Our Message </label>
                        <div class="col-sm-7">
                            <textarea name="message1_{{$lang}}" cols="30" rows="10"
                                      class="form-control {{$errors->first('message1'.$lang) ? "is-invalid" : "" }} "
                                      id="summernote{{$lang}}">{{old($about->getTranslation('message1',$lang)) ? old($about->getTranslation('message1',$lang)) : $about->getTranslation('message1',$lang)}}</textarea>
                            <div class="invalid-feedback">
                                {{ $errors->first('message1') }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group ml-5">
                        <label for="message2" class="col-sm-2 col-form-label">Our Message Details </label>
                        <div class="col-sm-7">
                            <textarea name="message2_{{$lang}}" cols="30" rows="10"
                                      class="form-control {{$errors->first('message2'.$lang) ? "is-invalid" : "" }} "
                                      id="summernote{{$lang}}">{{old($about->getTranslation('message2',$lang)) ? old($about->getTranslation('message2',$lang)) : $about->getTranslation('message2',$lang)}}</textarea>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group ml-5">
                        <label for="vision" class="col-sm-2 col-form-label">Our Vision </label>
                        <div class="col-sm-7">
                            <textarea name="vision_{{$lang}}" cols="30" rows="10"
                                      class="form-control {{$errors->first('vision'.$lang) ? "is-invalid" : "" }} "
                                      id="summernote{{$lang}}">{{old($about->getTranslation('vision',$lang)) ? old($about->getTranslation('vision',$lang)) : $about->getTranslation('vision',$lang)}}</textarea>
                            <div class="invalid-feedback">
                                {{ $errors->first('vision') }}
                            </div>
                        </div>
